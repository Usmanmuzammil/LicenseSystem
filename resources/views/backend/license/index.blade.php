                        ...
                        <div class="col-xl-12">
                            <div class="card">
                                <div class="card-header align-items-center d-flex">
                                    <h4 class="card-title mb-0 flex-grow-1">License</h4>
                                    <div class="flex-shrink-0">
                                        <div class="form-check form-switch form-switch-right form-switch-md">
                                            <a href="{{route('admin.user.create')}}"  class="btn btn-primary btn-sm"><i class="bi bi-plus"></i> Add License</a>
    ...
    $(document).ready(function() {
        $('.category-table').DataTable({
            ...
            columns: [
                ...
                { data: 'name', name: 'name' },
                { data: 'father_or_husband', name: 'father_or_husband' },
