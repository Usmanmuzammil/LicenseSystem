...
@section('title','Create Punjab License')
@section('content')
            ...
            <div class="row">
                <div class="col-12">
                    <div class="page-title-box d-sm-flex align-items-center justify-content-between">
                        <h4 class="mb-sm-0">Create Punjab License</h4>

                        <div class="page-title-right">
                            <ol class="breadcrumb m-0">
                                <li class="breadcrumb-item"><a href="javascript: void(0);">Punjab Licenses</a></li>
                                <li class="breadcrumb-item active">Create Punjab License</li>
                            </ol>
                        </div>
                ...
                <div class="col-lg-12">
                    <div class="card">
                        <div class="card-header align-items-center d-flex">
                            <h4 class="card-title mb-0 flex-grow-1">Create Punjab License</h4>
                            <div class="flex-shrink-0">
                                <div class="form-check form-switch form-switch-right form-switch-md">
                                    <a href="{{route('admin.punjablicense.index')}}" class="btn btn-danger btn-sm"><i class="bi bi-arrow-left"></i> Back</a>
                                </div>
                            </div>
                        </div><!-- end card header -->
                        <div class="card-body">
                            <div class="live-preview">
                                <form action="{{ route('admin.punjablicense.store') }}" method="POST" enctype="multipart/form-data" id="userForm">
                                    @csrf
                                    <div class="row gy-4">
                                        <!-- Movie Details -->
                                        ...
                                        <div class="col-xxl-3 col-md-6">
                                            <div>
                                                <label for="image" class="form-label">Son/Daughter/Wife</label>
                                                <input type="text" class="form-control" name="son_daughter_wife" placeholder="Enter father or husband name" value="{{old('son_daughter_wife')}}" required>
                                        ...
                                        <div class="col-xxl-3 col-md-6">
                                            <div>
                                                <label for="artist" class="form-label">Valid Till</label>
                                        ...
                                        <div class="col-md-6">
                                            ...
                                            <input type="number" class="form-control" name="emergency_contact" placeholder="Enter blood group" value="{{old('emergency_contact')}}">
                                        ...
                                        <div class="col-md-6">
                                            ...
                                            <input type="number" class="form-control" name="passport_number" placeholder="Enter blood group" value="{{old('passport_number')}}">
                                        ...
                                        <div class="col-md-6">
                                            ...
                                            <input type="text" class="form-control" name="nationality" placeholder="Enter blood group" value="{{old('nationality')}}">
                                            @error('nationality')
                                                <span class="text-danger">{{ $message }}</span>
                                            @enderror
                                        </div>
                                        ...
                                        <div class="col-md-6">
                                            ...
                                            <input type="number" class="form-control" name="previous_license_number" placeholder="Enter old dl" value="{{old('previous_license_number')}}">
    ...
    if (cropper) {
        ...
        canvas.toBlob((blob) => {
            ...
            .then(response => {
                if (response.ok) {
                    console.log("Image uploaded successfully.");
                    window.location.href = "{{route('admin.punjablicense.index')}}"
                    toast('Punjab License created successfully','success')
                } else {
                    console.error("Error uploading image.");
                }
            })
