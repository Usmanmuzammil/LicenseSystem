...
class SettingsContrller extends Controller
{
    ...
    public function storeSiteSettings(Request $request)
    {
        ...
        if($request->hasFile('site_logo')){
            ...
            $siteLogo = time().'.'.$ext;
            $logo = 'assets/backend/uploads/site_logo/'.$siteLogo;
            $uploadPath = 'assets/backend/uploads/site_logo';
            $file->move($uploadPath,$siteLogo);
            $this->saveSetting('site_logo', $logo);
        }
        ...
        if($request->hasFile('site_favicon')){
            ...
            $favicon = 'assets/backend/uploads/site_favicon/'.$siteFavicon;
            $uploadPath = 'assets/backend/uploads/site_favicon';
            $file->move($uploadPath,$siteFavicon);
            $this->saveSetting('site_favicon', $favicon);
        }
